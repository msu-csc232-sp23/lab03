        ...
        struct ConsoleReporter : public IReporter {
            ...
            void test_run_end(const TestRunStats &p) override {
                ...
                auto totwidth = int(std::ceil(
                        log10((std::max(p.numTestCasesPassingFilters, static_cast<unsigned>(p.numAsserts))) + 1)));
                ...
                auto failwidth = int(std::ceil(
                        log10((std::max(p.numTestCasesFailed, static_cast<unsigned>(p.numAssertsFailed))) + 1)));
